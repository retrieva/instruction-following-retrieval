...
def main():
    ...
    model = INSRTUCTIRMODEL.from_pretrained(
        base_model_name_or_path="meta-llama/Meta-Llama-3-8B-Instruct",  # "meta-llama/Llama-3.2-1B-Instruct",
    ...
    training_args = TrainingArguments(
        output_dir = "/home/pj25000118/ku50001652/works/2025_internship/save_model/test",
        num_train_epochs = 1,
